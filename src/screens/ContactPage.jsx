            ...
            <div className="relative w-full max-w-6xl">
                ...
                <div className="backdrop-blur-xl bg-transparent border border-[#4D273F] rounded-3xl p-4 md:p-12 shadow-2xl">
                    ...
                    <div className="space-y-6">
                        {/* Name Field */}
                        <div className="group">
                            <label htmlFor="name" className="block text-white font-medium mb-2 text-sm uppercase tracking-wider">
                                Full Name
                            </label>
                        ...
                        {/* Email Field */}
                        <div className="group">
                            <label htmlFor="email" className="block text-white font-medium mb-2 text-sm uppercase tracking-wider">
                                Email Address
                            </label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        {/* Message Field */}
                        <div>
                            <label htmlFor="message" className="block text-white font-medium mb-2 text-sm uppercase tracking-wider">
                                Message
                            </label>
                            <textarea
                                id="message"
