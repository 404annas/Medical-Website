...
const ServicesPage = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-black via-gray-900 to-black pt-36 pb-20">
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-32">
            ...
            {specialtyServices.map((service, index) => {
              ...
              return (
                <div key={index} className="group relative overflow-hidden">
                  <div className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6 hover:border-gray-700/70 transition-all duration-500 hover:-translate-y-2">
